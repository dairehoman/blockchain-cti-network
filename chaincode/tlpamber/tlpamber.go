...
// TLPAMBER -
type TLPAMBER struct {
}

// Init -
func (t *TLPAMBER) Init(stub shim.ChaincodeStubInterface) pb.Response {
	return shim.Success(nil)
}

// Invoke -
func (t *TLPAMBER) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
...
func set(stub shim.ChaincodeStubInterface, args []string) (string, error) {
	...
	if args[8] == "amber" {
		...
		return "", fmt.Errorf("Contract Violation: Only TLP AMBER permiited on this channel%s", args[0])
	}
...
//main -
func main() {
	if err := shim.Start(new(TLPAMBER)); err != nil {
