...
// Init -
func (t *TLPRED) Init(stub shim.ChaincodeStubInterface) pb.Response {
	return shim.Success(nil)
}

// Invoke -
func (t *TLPRED) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
...
//main -
func main() {
	if err := shim.Start(new(TLPRED)); err != nil {
